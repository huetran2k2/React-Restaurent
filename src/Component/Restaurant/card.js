       ...
       <Fragment>
         <div className="col-lg-3 col-sm-6">
                <div className="product text-center skel-loader">
                  <div className="d-block mb-3 position-relative"><a className="d-block" href="detail.html"><img className="img-fluid w-100" src={[this.props.image]} alt="..." /></a>
                  ...
                  <p className="small text-muted">{this.props.price}đ</p>
                </div>
              </div>
       </Fragment>
      );
